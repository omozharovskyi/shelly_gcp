...
3. Package the 'python' directory into a ZIP file named 'google-storage.zip'.
...
7. Choose compatible runtimes, e.g., Python 3.8.
8. Click "Create".
...
Conclusion:
The Lambda Layer is now ready and attached to your Lambda function. You can uncomment the upload step in the provided scripts if you prefer to automate the layer upload process in the future. This guide aims to provide flexibility in how you manage and deploy Lambda Layers for your AWS Lambda functions.